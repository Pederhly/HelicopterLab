 ...
 * C source code generated on : Thu Sep 23 11:21:09 2021
 *
...
void heli_q8_oppgave1_output0(void)    /* Sample time: [0.0s, 0.0s] */
{
  ...
  heli_q8_oppgave1_B.TransferFcn = 0.0;
  heli_q8_oppgave1_B.TransferFcn += heli_q8_oppgave1_P.TransferFcn_C *
    heli_q8_oppgave1_X.TransferFcn_CSTATE;
  ...
  for (iy = 0; iy < 2; iy++) {
    ...
    heli_q8_oppgave1_B.u[iy] = u_tmp_0 - ((heli_q8_oppgave1_P.K[iy + 2] *
      ...
      heli_q8_oppgave1_B.TransferFcn);
  ...
  if (rtmIsMajorTimeStep(heli_q8_oppgave1_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[5] = heli_q8_oppgave1_B.TransferFcn;
...
void heli_q8_oppgave1_derivatives(void)
{
  ...
  _rtXdot->TransferFcn_CSTATE += heli_q8_oppgave1_P.TransferFcn_A *
    heli_q8_oppgave1_X.TransferFcn_CSTATE;
  _rtXdot->TransferFcn_CSTATE += heli_q8_oppgave1_B.ElevationTransferFcn;
...
void heli_q8_oppgave1_initialize(void)
{
  ...
  heli_q8_oppgave1_X.TransferFcn_CSTATE = 0.0;
...
RT_MODEL_heli_q8_oppgave1_T *heli_q8_oppgave1(void)
{
  ...
  /* External mode info */
  heli_q8_oppgave1_M->Sizes.checksums[0] = (2255597935U);
  heli_q8_oppgave1_M->Sizes.checksums[1] = (1245089091U);
  heli_q8_oppgave1_M->Sizes.checksums[2] = (2223558241U);
  heli_q8_oppgave1_M->Sizes.checksums[3] = (4084254668U);
  ...
  /* Initialize Sizes */
  heli_q8_oppgave1_M->Sizes.numContStates = (7);/* Number of continuous states */
  ...
  heli_q8_oppgave1_M->Sizes.numBlocks = (65);/* Number of blocks */
  heli_q8_oppgave1_M->Sizes.numBlockIO = (22);/* Number of block outputs */
  heli_q8_oppgave1_M->Sizes.numBlockPrms = (211);/* Sum of parameter "widths" */
