...
#ifndef RTW_HEADER_lab2_task2_model_h_
#define RTW_HEADER_lab2_task2_model_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef lab2_task2_model_COMMON_INCLUDES_
#define lab2_task2_model_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* lab2_task2_model_COMMON_INCLUDES_ */

#include "lab2_task2_model_types.h"
...
#define lab2_task2_model_rtModel       RT_MODEL_lab2_task2_model_T
...
typedef struct {
  ...
  boolean_T OR;                        /* '<S4>/OR' */
  boolean_T Compare_m;                 /* '<S8>/Compare' */
} B_lab2_task2_model_T;
...
typedef struct {
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWs_PWORK;                      /* '<S13>/FromWs' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWs_PWORK_j;                    /* '<S14>/FromWs' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWs_PWORK_f;                    /* '<S12>/FromWs' */

  struct {
    void *LoggedData[2];
  } Controller_scope_PWORK;            /* '<Root>/Controller_scope' */
  ...
  struct {
    int_T PrevIndex;
  } FromWs_IWORK;                      /* '<S13>/FromWs' */

  struct {
    int_T PrevIndex;
  } FromWs_IWORK_p;                    /* '<S14>/FromWs' */

  struct {
    int_T PrevIndex;
  } FromWs_IWORK_k;                    /* '<S12>/FromWs' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK;                      /* '<S2>/To File' */
} DW_lab2_task2_model_T;
...
typedef struct {
  ...
  real_T TransferFcn_CSTATE_l;         /* '<S2>/Transfer Fcn' */
...
typedef struct {
  ...
  boolean_T TransferFcn_CSTATE_l;      /* '<S2>/Transfer Fcn' */
...
#define rtB                            lab2_task2_model_B
#define BlockIO                        B_lab2_task2_model_T
#define rtX                            lab2_task2_model_X
#define ContinuousStates               X_lab2_task2_model_T
#define rtXdot                         lab2_task2_model_XDot
#define StateDerivatives               XDot_lab2_task2_model_T
#define tXdis                          lab2_task2_model_XDis
#define StateDisabled                  XDis_lab2_task2_model_T
#define rtP                            lab2_task2_model_P
#define Parameters                     P_lab2_task2_model_T
#define rtDWork                        lab2_task2_model_DW
#define D_Work                         DW_lab2_task2_model_T

/* Parameters (default storage) */
struct P_lab2_task2_model_T_ {
  ...
  real_T K_aug[10];                    /* Variable: K_aug
                                        ...
                                        *   '<S5>/K1'
                                        */
  real_T Lab2TestToRun;                /* Variable: Lab2TestToRun
                                        * Referenced by:
                                        *   '<S4>/Constant1'
                                        *   '<S4>/Constant4'
                                        */
  ...
  real_T Constant3_Value;              /* Expression: 0
                                        ...
                                        */
  real_T Referenceselector_Value;      /* Expression: 1
  ...
  real_T Constant2_Value;              /* Expression: 0
                                        ...
                                        */
  real_T Step2_Time;                   /* Expression: 45
                                        * Referenced by: '<S4>/Step2'
                                        */
  real_T Step2_Y0;                     /* Expression: 0
                                        * Referenced by: '<S4>/Step2'
                                        */
  real_T Step2_YFinal;                 /* Expression: -0.1
                                        * Referenced by: '<S4>/Step2'
                                        */
...
struct tag_RTM_lab2_task2_model_T {
  const char_T *path;
...
extern P_lab2_task2_model_T lab2_task2_model_P;

/* Block signals (default storage) */
extern B_lab2_task2_model_T lab2_task2_model_B;

/* Continuous states (default storage) */
extern X_lab2_task2_model_T lab2_task2_model_X;

/* Block states (default storage) */
extern DW_lab2_task2_model_T lab2_task2_model_DW;
...
extern void lab2_task2_model_initialize(void);
extern void lab2_task2_model_output0(void);
extern void lab2_task2_model_update0(void);
extern void lab2_task2_model_output(int_T tid);
extern void lab2_task2_model_update(int_T tid);
extern void lab2_task2_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab2_task2_model_rtModel *lab2_task2_model(void);
...
extern RT_MODEL_lab2_task2_model_T *const lab2_task2_model_M;
 ...
 *
 * '<Root>' : 'lab2_task2_model'
 * '<S1>'   : 'lab2_task2_model/Conversion'
 * '<S2>'   : 'lab2_task2_model/Data logging'
 * '<S3>'   : 'lab2_task2_model/Heli 3D'
 * '<S4>'   : 'lab2_task2_model/Reference generator'
 * '<S5>'   : 'lab2_task2_model/Subsystem'
 * '<S6>'   : 'lab2_task2_model/Reference generator/Compare To Constant'
 * '<S7>'   : 'lab2_task2_model/Reference generator/Compare To Constant1'
 * '<S8>'   : 'lab2_task2_model/Reference generator/Compare To Constant2'
 * '<S9>'   : 'lab2_task2_model/Reference generator/Compare To Constant3'
 * '<S10>'  : 'lab2_task2_model/Reference generator/Compare To Constant4'
 * '<S11>'  : 'lab2_task2_model/Reference generator/Joystick'
 * '<S12>'  : 'lab2_task2_model/Reference generator/Test 1-4'
 * '<S13>'  : 'lab2_task2_model/Reference generator/Test 5'
 * '<S14>'  : 'lab2_task2_model/Reference generator/Test 6'
 */
#endif                                 /* RTW_HEADER_lab2_task2_model_h_ */
