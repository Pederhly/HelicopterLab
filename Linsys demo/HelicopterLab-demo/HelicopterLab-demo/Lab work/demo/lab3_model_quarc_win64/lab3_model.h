...
#ifndef RTW_HEADER_lab3_model_h_
#define RTW_HEADER_lab3_model_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef lab3_model_COMMON_INCLUDES_
#define lab3_model_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* lab3_model_COMMON_INCLUDES_ */

#include "lab3_model_types.h"
...
#define lab3_model_rtModel             RT_MODEL_lab3_model_T
...
typedef struct {
  ...
  struct {
    void *LoggedData[3];
  } Estimate_vs_encoder_PWORK;         /* '<Root>/Estimate_vs_encoder' */
  ...
  real32_T UnitDelay_DSTATE_d;         /* '<S15>/Unit Delay' */
...
#define rtB                            lab3_model_B
#define BlockIO                        B_lab3_model_T
#define rtX                            lab3_model_X
#define ContinuousStates               X_lab3_model_T
#define rtXdot                         lab3_model_XDot
#define StateDerivatives               XDot_lab3_model_T
#define tXdis                          lab3_model_XDis
#define StateDisabled                  XDis_lab3_model_T
#define rtP                            lab3_model_P
#define Parameters                     P_lab3_model_T
#define rtDWork                        lab3_model_DW
#define D_Work                         DW_lab3_model_T

/* Parameters (default storage) */
struct P_lab3_model_T_ {
  ...
  real_T Gain1_Gain[9];             /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
                                     ...
                                     */
  real_T Gain2_Gain_p[9];           /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
...
extern P_lab3_model_T lab3_model_P;

/* Block signals (default storage) */
extern B_lab3_model_T lab3_model_B;

/* Continuous states (default storage) */
extern X_lab3_model_T lab3_model_X;

/* Block states (default storage) */
extern DW_lab3_model_T lab3_model_DW;
...
extern void lab3_model_initialize(void);
extern void lab3_model_output0(void);
extern void lab3_model_update0(void);
extern void lab3_model_output(int_T tid);
extern void lab3_model_update(int_T tid);
extern void lab3_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab3_model_rtModel *lab3_model(void);
...
extern RT_MODEL_lab3_model_T *const lab3_model_M;
 ...
 *
 * '<Root>' : 'lab3_model'
 * '<S1>'   : 'lab3_model/Conversion'
 * '<S2>'   : 'lab3_model/Data logging'
 * '<S3>'   : 'lab3_model/Estimator'
 * '<S4>'   : 'lab3_model/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S5>'   : 'lab3_model/Heli 3D'
 * '<S6>'   : 'lab3_model/IMU_BT'
 * '<S7>'   : 'lab3_model/LQR controller with integral action'
 * '<S8>'   : 'lab3_model/Reference1'
 * '<S9>'   : 'lab3_model/Vs_0'
 * '<S10>'  : 'lab3_model/IMU_BT/Check if equal'
 * '<S11>'  : 'lab3_model/IMU_BT/Check if equal1'
 * '<S12>'  : 'lab3_model/IMU_BT/Check if equal2'
 * '<S13>'  : 'lab3_model/IMU_BT/Check if equal3'
 * '<S14>'  : 'lab3_model/IMU_BT/Check if equal4'
 * '<S15>'  : 'lab3_model/IMU_BT/Check if equal5'
 * '<S16>'  : 'lab3_model/IMU_BT/Skip to next line'
 * '<S17>'  : 'lab3_model/Reference1/Joystick'
 */
#endif                                 /* RTW_HEADER_lab3_model_h_ */
