...
#ifndef RTW_HEADER_lab2_task1_model_h_
#define RTW_HEADER_lab2_task1_model_h_
#include <stddef.h>
#include <string.h>
#ifndef lab2_task1_model_COMMON_INCLUDES_
#define lab2_task1_model_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* lab2_task1_model_COMMON_INCLUDES_ */

#include "lab2_task1_model_types.h"
...
#define lab2_task1_model_rtModel       RT_MODEL_lab2_task1_model_T
...
#define rtB                            lab2_task1_model_B
#define BlockIO                        B_lab2_task1_model_T
#define rtX                            lab2_task1_model_X
#define ContinuousStates               X_lab2_task1_model_T
#define rtXdot                         lab2_task1_model_XDot
#define StateDerivatives               XDot_lab2_task1_model_T
#define tXdis                          lab2_task1_model_XDis
#define StateDisabled                  XDis_lab2_task1_model_T
#define rtP                            lab2_task1_model_P
#define Parameters                     P_lab2_task1_model_T
#define rtDWork                        lab2_task1_model_DW
#define D_Work                         DW_lab2_task1_model_T

/* Parameters (default storage) */
struct P_lab2_task1_model_T_ {
  ...
  real_T Step7_YFinal;                 /* Expression: 0.1
                                        * Referenced by: '<S5>/Step7'
                                        */
  real_T Step9_Time;                   /* Expression: 43
                                        * Referenced by: '<S5>/Step9'
                                        */
  real_T Step9_Y0;                     /* Expression: 0
                                        * Referenced by: '<S5>/Step9'
                                        */
  real_T Step9_YFinal;                 /* Expression: -0.1
                                        * Referenced by: '<S5>/Step9'
                                        */
...
struct tag_RTM_lab2_task1_model_T {
  const char_T *path;
...
extern P_lab2_task1_model_T lab2_task1_model_P;

/* Block signals (default storage) */
extern B_lab2_task1_model_T lab2_task1_model_B;

/* Continuous states (default storage) */
extern X_lab2_task1_model_T lab2_task1_model_X;

/* Block states (default storage) */
extern DW_lab2_task1_model_T lab2_task1_model_DW;
...
extern void lab2_task1_model_initialize(void);
extern void lab2_task1_model_output0(void);
extern void lab2_task1_model_update0(void);
extern void lab2_task1_model_output(int_T tid);
extern void lab2_task1_model_update(int_T tid);
extern void lab2_task1_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab2_task1_model_rtModel *lab2_task1_model(void);
...
extern RT_MODEL_lab2_task1_model_T *const lab2_task1_model_M;
 ...
 *
 * '<Root>' : 'lab2_task1_model'
 * '<S1>'   : 'lab2_task1_model/Conversion'
 * '<S2>'   : 'lab2_task1_model/Data logging'
 * '<S3>'   : 'lab2_task1_model/Heli 3D'
 * '<S4>'   : 'lab2_task1_model/Heli_model'
 * '<S5>'   : 'lab2_task1_model/Reference'
 * '<S6>'   : 'lab2_task1_model/Reference/Joystick'
 */
#endif                                 /* RTW_HEADER_lab2_task1_model_h_ */
