...
#ifndef RTW_HEADER_lab4_model_h_
#define RTW_HEADER_lab4_model_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef lab4_model_COMMON_INCLUDES_
#define lab4_model_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* lab4_model_COMMON_INCLUDES_ */

#include "lab4_model_types.h"
...
#define lab4_model_rtModel             RT_MODEL_lab4_model_T
...
typedef struct {
  ...
  real32_T UnitDelay_c;                /* '<S10>/Unit Delay' */
  real32_T UnitDelay_d;                /* '<S11>/Unit Delay' */
  real32_T UnitDelay_n;                /* '<S12>/Unit Delay' */
  real32_T UnitDelay_i;                /* '<S13>/Unit Delay' */
  real32_T UnitDelay_c0;               /* '<S14>/Unit Delay' */
  real32_T UnitDelay_a;                /* '<S15>/Unit Delay' */
  ...
  boolean_T RelationalOperator_k;      /* '<S11>/Relational Operator' */
  boolean_T RelationalOperator_p;      /* '<S12>/Relational Operator' */
  boolean_T RelationalOperator_n;      /* '<S13>/Relational Operator' */
  boolean_T RelationalOperator_g;      /* '<S14>/Relational Operator' */
...
typedef struct {
  ...
  struct {
    void *LoggedData[6];
  } Estimat_vs_encoder1_PWORK;         /* '<Root>/Estimat_vs_encoder1' */
  ...
  struct {
    void *LoggedData[2];
  } Scope_PWORK_ck;                    /* '<S12>/Scope' */

  struct {
    void *LoggedData[2];
  } Scope_PWORK_k;                     /* '<S13>/Scope' */

  struct {
    void *LoggedData[2];
  } Scope_PWORK_i;                     /* '<S14>/Scope' */

  struct {
    void *LoggedData[2];
  } Scope_PWORK_n;                     /* '<S15>/Scope' */
  ...
  real32_T UnitDelay_DSTATE_d;         /* '<S10>/Unit Delay' */
  real32_T UnitDelay_DSTATE_h;         /* '<S11>/Unit Delay' */
  real32_T UnitDelay_DSTATE_f;         /* '<S12>/Unit Delay' */
  real32_T UnitDelay_DSTATE_e;         /* '<S13>/Unit Delay' */
  real32_T UnitDelay_DSTATE_j;         /* '<S14>/Unit Delay' */
  real32_T UnitDelay_DSTATE_dd;        /* '<S15>/Unit Delay' */
...
#define rtB                            lab4_model_B
#define BlockIO                        B_lab4_model_T
#define rtX                            lab4_model_X
#define ContinuousStates               X_lab4_model_T
#define rtXdot                         lab4_model_XDot
#define StateDerivatives               XDot_lab4_model_T
#define tXdis                          lab4_model_XDis
#define StateDisabled                  XDis_lab4_model_T
#define rtP                            lab4_model_P
#define Parameters                     P_lab4_model_T
#define rtDWork                        lab4_model_DW
#define D_Work                         DW_lab4_model_T

/* Parameters (default storage) */
struct P_lab4_model_T_ {
...
extern P_lab4_model_T lab4_model_P;

/* Block signals (default storage) */
extern B_lab4_model_T lab4_model_B;

/* Continuous states (default storage) */
extern X_lab4_model_T lab4_model_X;

/* Block states (default storage) */
extern DW_lab4_model_T lab4_model_DW;
...
extern void lab4_model_initialize(void);
extern void lab4_model_output0(void);
extern void lab4_model_update0(void);
extern void lab4_model_output(int_T tid);
extern void lab4_model_update(int_T tid);
extern void lab4_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab4_model_rtModel *lab4_model(void);
...
extern RT_MODEL_lab4_model_T *const lab4_model_M;
 ...
 *
 * '<Root>' : 'lab4_model'
 * '<S1>'   : 'lab4_model/Conversion'
 * '<S2>'   : 'lab4_model/Data logging'
 * '<S3>'   : 'lab4_model/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S4>'   : 'lab4_model/Heli 3D'
 * '<S5>'   : 'lab4_model/IMU_BT'
 * '<S6>'   : 'lab4_model/Kalman filter'
 * '<S7>'   : 'lab4_model/LQR controller with integral action'
 * '<S8>'   : 'lab4_model/Reference1'
 * '<S9>'   : 'lab4_model/Vs_0'
 * '<S10>'  : 'lab4_model/IMU_BT/Check if equal'
 * '<S11>'  : 'lab4_model/IMU_BT/Check if equal1'
 * '<S12>'  : 'lab4_model/IMU_BT/Check if equal2'
 * '<S13>'  : 'lab4_model/IMU_BT/Check if equal3'
 * '<S14>'  : 'lab4_model/IMU_BT/Check if equal4'
 * '<S15>'  : 'lab4_model/IMU_BT/Check if equal5'
 * '<S16>'  : 'lab4_model/IMU_BT/Skip to next line'
 * '<S17>'  : 'lab4_model/Kalman filter/Kalman_estimation'
 * '<S18>'  : 'lab4_model/Kalman filter/Kalman_predictor'
 * '<S19>'  : 'lab4_model/Kalman filter/Make y'
 * '<S20>'  : 'lab4_model/Reference1/Joystick'
 */
#endif                                 /* RTW_HEADER_lab4_model_h_ */
