...
RT_MODEL_heli_q8_oppgave3_T *heli_q8_oppgave3(void)
{
  ...
  /* External mode info */
  heli_q8_oppgave3_M->Sizes.checksums[0] = (3251990070U);
  heli_q8_oppgave3_M->Sizes.checksums[1] = (4200204427U);
  heli_q8_oppgave3_M->Sizes.checksums[2] = (3654577530U);
  heli_q8_oppgave3_M->Sizes.checksums[3] = (1179163832U);
