 ...
 * C source code generated on : Mon Nov 22 00:46:43 2021
 *
...
void heli_q8_oppgave3_output0(void)    /* Sample time: [0.0s, 0.0s] */
{
  ...
  rtb_StateSpace[0] = heli_q8_oppgave3_B.PitchCounttorad;
  rtb_StateSpace[1] = heli_q8_oppgave3_B.PitchTransferFcn;
  rtb_StateSpace[2] = heli_q8_oppgave3_B.TransferFcn;
  ...
  for (iy = 0; iy < 2; iy++) {
     ...
     */
    phi = heli_q8_oppgave3_P.F_aug[iy + 2] * heli_q8_oppgave3_B.Switch1 +
      heli_q8_oppgave3_P.F_aug[iy] * heli_q8_oppgave3_B.Switch;
    ...
    az = 0.0;
    for (ci = 0; ci < 5; ci++) {
      az += heli_q8_oppgave3_P.K_aug[(ci << 1) + iy] * rtb_StateSpace[ci];
    }

    heli_q8_oppgave3_B.u[iy] = phi - az;
...
RT_MODEL_heli_q8_oppgave3_T *heli_q8_oppgave3(void)
{
  ...
  /* External mode info */
  heli_q8_oppgave3_M->Sizes.checksums[0] = (1533205849U);
  heli_q8_oppgave3_M->Sizes.checksums[1] = (176998456U);
  heli_q8_oppgave3_M->Sizes.checksums[2] = (2208891380U);
  heli_q8_oppgave3_M->Sizes.checksums[3] = (3658476950U);
  ...
  heli_q8_oppgave3_M->Sizes.numBlockIO = (55);/* Number of block outputs */
